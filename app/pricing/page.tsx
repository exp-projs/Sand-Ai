...
const PRICING_TIERS = [
  {
    ...
    features: [
      'Conversational Core (24/7 WhatsApp Agent)',
      'Autonomous Social Hub (up to 2 accounts)',
      'Automated marketing metrics email digests',
      'Standard cloud rendering pipeline access',
  ...
  },
  {
    ...
    features: [
      ...
      'Autonomous Social Hub (up to 4 accounts)',
      'Digital Architecture (Premium custom SEO site)',
      'Priority routing for customer acquisition webhooks',
      'Interactive real-time lead sync systems',
      'Advanced SMS and email transactional alerts',
  ...
  },
  {
    ...
    features: [
      ...
      'Tailored iOS & Android native apps',
      'Unlimited Social Hub accounts sync',
      'Custom database schema & system architecture integrations',
      'High-performance Performance Ads automation',
